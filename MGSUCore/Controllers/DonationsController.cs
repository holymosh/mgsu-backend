...
namespace MGSUCore.Controllers
{
    ...
    public class DonationsController : Controller
    {
        ...
        public DonationsController(IDonationManager donationManager, IProjectManager projectManager,
        ...
        public IActionResult Put(string id, [FromBody] SaveDonationModel donationModel)
        {
            ...
            oldDonation.ProjectId = donationModel.ProjectId == ObjectId.Empty
                ? oldDonation.ProjectId
                : donationModel.ProjectId;
